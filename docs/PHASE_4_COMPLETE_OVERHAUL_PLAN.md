...
@media (min-width: 480px)  { /* Standard phones */ }
@media (min-width: 640px)  { /* Large phones / small tablets */ }
@media (min-width: 768px)  { /* Tablets portrait */ }
@media (min-width: 1024px) { /* Tablets landscape / small desktop */ }
...
.table-surface {
    ...
    box-shadow:
        ...
        0 0 0 4px var(--rail-color);                  /* rail edge */
}
```
...
```css
.position-badge {
    background: radial-gradient(circle at 35% 35%, #fff3 0%, transparent 60%),
...
```css
@media (orientation: landscape) and (max-height: 500px) {
    .table-page { flex-direction: row; }
    .table-area { width: 60%; }
    .action-area { width: 40%; flex-direction: column; }
}
```
