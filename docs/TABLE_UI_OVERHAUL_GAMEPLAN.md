...
**Phase 2 — Polish**
5. Bottom Controls → Clean strip with icons
6. Community Cards → Size up, better spacing
7. Timer → Circular arc variant
8. Pre-action buttons → New component

**Phase 3 — Feel**
9. Sound effects → Full suite
10. Animations → Chip movement, card dealing, win effects
11. Testing → Full E2E on mobile viewport
...
*This document serves as the complete blueprint. Every change listed here needs to happen to bring our table UI from "broken prototype" to "professional poker app."*
