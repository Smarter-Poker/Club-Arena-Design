...
## Deployment
- Server runs as a separate Node.js process (NOT on Vercel)
- Client (Vite/React) deploys to Vercel automatically on git push
- Server needs manual deployment/restart
