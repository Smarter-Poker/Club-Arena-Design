 ...
 */
export function PositionBadge({ position }: { position: 'BTN' | 'SB' | 'BB' | 'UTG' | 'CO' | 'HJ' }) {
 ...
 */
export function TournamentStatusBadge({ status }: { status: 'registering' | 'running' | 'late_reg' | 'on_break' | 'final_table' | 'finished' | 'cancelled' }) {
...
export function NewBadge() {
    return <Badge variant="primary" size="small">NEW</Badge>;
}
...
export function ProBadge() {
    return <Badge variant="vip" size="small">PRO</Badge>;
}
