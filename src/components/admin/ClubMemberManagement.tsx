...
export function ClubMemberManagement({ clubId, isAdmin }: ClubMemberManagementProps) {
    ...
    filteredMembers.sort((a, b) => {
        switch (sortBy) {
            ...
            case 'rake': return b.totalRake - a.totalRake;
            case 'joined': return b.joinedAt.getTime() - a.joinedAt.getTime();
                    ...
                    >
                        ...
                        <div className="info">
                            ...
                            <span className="stats">
                                Balance: {member.balance.toLocaleString()} • Rake: {member.totalRake.toLocaleString()}
                            </span>
                        </div>
