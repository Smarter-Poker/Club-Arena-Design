        ...
        <div className="tos-modal-overlay">
            <div className="tos-modal" style={{ opacity: mounted ? 1 : 0, transform: mounted ? 'translateY(0)' : 'translateY(8px)', transition: 'all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275)' }}>
                ...
                <div className="tos-content" onScroll={handleScroll}>
                    ...
                    <p>
                        By accessing or using Club Arena ("the Service"), you agree to be bound by these
                        Terms of Service. If you do not agree to these terms, you may not use the Service.
                    </p>

                    <h3>2. Description of Service</h3>
                    <p>
                        Club Arena is a poker club management platform that enables users to create and
                        join private poker clubs, manage agents and players, and participate in poker games.
                    </p>
                    ...
                    <p>
                        The Service uses virtual chips and diamonds for gameplay purposes. Virtual currency
                        has no real-world monetary value and cannot be exchanged for real money, goods, or
                    ...
                    <p>
                        All content, features, and functionality of the Service are owned by Smarter.Poker
                    ...
                    <h3>12. Contact</h3>
                    <p>
                        For questions about these Terms, please contact us at support@smarter.poker
                    </p>
