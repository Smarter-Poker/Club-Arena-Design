                ...
                <div className="leaks-section">
                    ...
                    <div className="leak-item">
                        ...
                        <div className="leak-info">
                            ...
                            <p>You're 3-betting only 4.2% which is below optimal (6-8%). Consider widening your 3-bet range in position.</p>
                        </div>
                    </div>
                    <div className="leak-item">
                        ...
                        <div className="leak-info">
                            ...
                            <p>Your turn c-bet of 72% is higher than optimal. Consider checking more missed draws.</p>
                        </div>
                    </div>
