...
const THEMES: Theme[] = [
    ...
    { id: 'gold', name: 'Gold Elite', previewColors: ['#292524', '#44403c', '#fbbf24'], isPremium: true },
];
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="theme-info">
                                ...
                                {theme.isPremium && (
                                    <span className="theme-badge premium"> Gold</span>
                                )}
                                {theme.isVip && !theme.isPremium && (
                                    <span className="theme-badge vip"> VIP</span>
                                )}
                            </div>
