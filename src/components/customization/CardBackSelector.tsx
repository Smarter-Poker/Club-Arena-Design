                        ...
                        >
                            <div className="card-back-preview">
                                <div className="card-shape">
                                    <span className="card-icon">{cardBack.preview}</span>
                                </div>
                            </div>
                            <span className="card-back-name">{cardBack.name}</span>

                            {!owned && cardBack.price && (
                                <span className="card-price"> {cardBack.price}</span>
                            )}
                            {!owned && cardBack.isPremium && (
                                <span className="card-premium"> VIP</span>
                            )}
