            ...
            <div className="stats-grid">
                ...
                <div className="stat-card level">
                    ...
                    <div className="stat-content">
                        ...
                        <span className="stat-label">Level {stats.currentLevel}/{stats.totalLevels}</span>
                    </div>
                ...
                <div className="stat-card average">
                    ...
                    <div className="stat-content">
                        ...
                        <span className="stat-label">
                            Avg ({getMRatio(stats.averageStack)}BB)
                        </span>
                    </div>
                </div>
                ...
                <div className="stat-card largest">
                    ...
                    <div className="stat-content">
                        ...
                        <span className="stat-label">
                            Largest ({getMRatio(stats.largestStack)}BB)
                        </span>
                    </div>
                </div>
                ...
                <div className="stat-card smallest">
                    ...
                    <div className="stat-content">
                        ...
                        <span className="stat-label">
                            Smallest ({getMRatio(stats.smallestStack)}BB)
                        </span>
                    </div>
                </div>
