...
const DEFAULT_DIAMOND_PRODUCTS: ProductItem[] = [
    { id: 'd1', name: 'Starter Pack', amount: 100, price: 0.99, currencySymbol: '◉', type: 'diamond' },
    { id: 'd2', name: 'Grinder Pack', amount: 550, bonus: 50, price: 4.99, currencySymbol: '◉', tag: 'Popular', type: 'diamond' },
    { id: 'd3', name: 'High Roller', amount: 1200, bonus: 200, price: 9.99, currencySymbol: '◉', tag: 'Best Value', type: 'diamond' },
    { id: 'd4', name: 'Whale Bundle', amount: 6500, bonus: 1500, price: 49.99, currencySymbol: '◉', type: 'diamond' },
];
...
const DEFAULT_GOLD_PRODUCTS: ProductItem[] = [
    ...
    { id: 'g2', name: 'Cash Game Kit', amount: 5500, bonus: 500, price: 4.99, currencySymbol: '◉', tag: 'Popular', type: 'gold' },
    { id: 'g3', name: 'Tournament Roll', amount: 12000, bonus: 2000, price: 9.99, currencySymbol: '◉', tag: 'Best Value', type: 'gold' },
    { id: 'g4', name: 'High Stakes Fund', amount: 65000, bonus: 15000, price: 49.99, currencySymbol: '◉', type: 'gold' },
];
