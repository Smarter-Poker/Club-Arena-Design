                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className={styles['modal-body']}>
                        ...
                        <div className={styles['form-group']}>
                            <label>Table Name <span style={{ color: '#ef4444' }}>*</span></label>
                            <input
                                type="text"
                                className="input"
                        ...
                        <div className={styles['form-row']}>
                            <div className={styles['form-group']}>
                                <label>Game Type <span style={{ color: '#ef4444' }}>*</span></label>
                                <select
                            ...
                            <div className={styles['form-group']}>
                                <label>Table Size <span style={{ color: '#ef4444' }}>*</span></label>
                                <select
                                    className={styles['form-select']}
                                    value={maxPlayers}
                        ...
                        {/* ── Stakes (required) ── */}
                        <div className={styles['form-group']}>
                            <label>Stakes <span style={{ color: '#ef4444' }}>*</span></label>
                        ...
                        <div className={styles['form-row']}>
                            <div className={styles['form-group']}>
                                <label>Min Buy-in (BB) <span style={{ color: '#ef4444' }}>*</span></label>
                                <input
                                    type="number"
                                    className="input"
                                    min="1"
                            ...
                            <div className={styles['form-group']}>
                                <label>Max Buy-in (BB) <span style={{ color: '#ef4444' }}>*</span></label>
                                <input
                                    type="number"
                                    className="input"
                                    min="1"
                        ...
                        ═══════════════════════════════════════════ */}
                        <div className={styles['form-group']}>
                            <label style={{ fontSize: '0.85rem', fontWeight: 700, color: '#10b981', marginBottom: 8 }}>
                                Game Features
                            </label>
                                ...
                                {settings.straddle_enabled && (
                                    <div style={{ paddingLeft: 20, marginBottom: 4 }}>
                                        <select
                                            ...
                                            onChange={e => setSettings(prev => ({ ...prev, straddle_type: e.target.value as any }))}
                                    ...
                                    <div className={styles['form-row']} style={{ paddingLeft: 20, marginBottom: 4 }}>
                                        <div className={styles['form-group']} style={{ flex: 1 }}>
                                            ...
                                            <input
                                                ...
                                                onChange={e => setSettings(prev => ({ ...prev, bomb_pot_frequency: parseInt(e.target.value) || 10 }))}
                                                style={{ fontSize: '0.7rem', padding: '2px 6px' }}
                                            />
                                        </div>
                                        <div className={styles['form-group']} style={{ flex: 1 }}>
                                            ...
                                            <input
                                                ...
                                                onChange={e => setSettings(prev => ({ ...prev, bomb_pot_ante_bb: parseInt(e.target.value) || 2 }))}
                                                style={{ fontSize: '0.7rem', padding: '2px 6px' }}
                                            />
                                        </div>
                                    </div>
