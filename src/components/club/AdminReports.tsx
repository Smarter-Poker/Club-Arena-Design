    ...
    <div className="reports-overlay" onClick={onClose}>
      <div className="reports-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="reports-modal__header">
          ...
          <button className="reports-modal__close" onClick={onClose}>
            ×
          </button>
        </div>
          ...
          <div className="reports-summary">
            ...
            <div className="summary-card">
              ...
              <span className="summary-value profit">
                ...
                {currency}
                {summary.insuranceProfit.toLocaleString()}
              </span>
            </div>
          </div>
                    ...
                    agents.map((agent, i) => (
                      ...
                      >
                        ...
                        <td className="text-right">
                          {currency}
                          {agent.totalRakeGenerated.toLocaleString()}
                        </td>
                        <td className="text-right commission">
                          {currency}
