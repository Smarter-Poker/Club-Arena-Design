        ...
        <nav className={styles.bottomNav}>
            ...
            <div className={styles.navItems}>
                ...
                <Link
                    ...
                    style={{ opacity: visibleItems.has(0) ? 1 : 0, transform: visibleItems.has(0) ? 'translateY(0)' : 'translateY(8px)', transition: 'all 0.35s cubic-bezier(0.175, 0.885, 0.32, 1.275)' }}
                >
                ...
                <Link
                    ...
                    style={{ opacity: visibleItems.has(1) ? 1 : 0, transform: visibleItems.has(1) ? 'translateY(0)' : 'translateY(8px)', transition: 'all 0.35s cubic-bezier(0.175, 0.885, 0.32, 1.275)' }}
                >
                    <svg className={styles.icon} viewBox="0 0 24 24" fill="currentColor">
                ...
                <Link
                    ...
                    style={{ opacity: visibleItems.has(2) ? 1 : 0, transform: visibleItems.has(2) ? 'translateY(0)' : 'translateY(8px)', transition: 'all 0.35s cubic-bezier(0.175, 0.885, 0.32, 1.275)' }}
                >
                    <svg className={styles.icon} viewBox="0 0 24 24" fill="currentColor">
                ...
                <Link
                    ...
                    style={{ opacity: visibleItems.has(3) ? 1 : 0, transform: visibleItems.has(3) ? 'translateY(0)' : 'translateY(8px)', transition: 'all 0.35s cubic-bezier(0.175, 0.885, 0.32, 1.275)' }}
                >
                    <svg className={styles.icon} viewBox="0 0 24 24" fill="currentColor">
                ...
                <Link
                    ...
                    style={{ opacity: visibleItems.has(4) ? 1 : 0, transform: visibleItems.has(4) ? 'translateY(0)' : 'translateY(8px)', transition: 'all 0.35s cubic-bezier(0.175, 0.885, 0.32, 1.275)' }}
                >
                    <svg className={styles.icon} viewBox="0 0 24 24" fill="currentColor">
