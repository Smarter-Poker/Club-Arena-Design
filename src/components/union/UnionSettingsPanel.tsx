            ...
            <div className="settings-section">
                ...
                <div className="setting-row">
                    ...
                    <select
                        ...
                        onChange={e => updateSetting('settlementFrequency', e.target.value as UnionSettings['settlementFrequency'])}
                        disabled={!isOwner}
                    >
            ...
            <div className="settings-section">
                ...
                <div className="setting-row toggle">
                    ...
                    <button
                        ...
                        onClick={() => updateSetting('requireApprovalForJoin', !settings.requireApprovalForJoin)}
                        disabled={!isOwner}
                    >
                        <span className="toggle-thumb" />
                    </button>
                ...
                <div className="setting-row">
                    ...
                    <div className="setting-input">
                        <input
                            ...
                            onChange={e => updateSetting('rakeCap', e.target.value ? Number(e.target.value) : null)}
                            placeholder="No cap"
                            disabled={!isOwner}
                        />
                        <span className="input-suffix">chips</span>
