...
function HandEntry({ hand, heroId, isExpanded, onToggle }: {
    hand: HandRecord;
    heroId: string;
    isExpanded: boolean;
    onToggle: () => void;
        ...
        <div className={`hh-entry ${isExpanded ? 'hh-entry--expanded' : ''}`}>
            ...
            <button className="hh-entry__summary" onClick={onToggle}>
                ...
                <span className="hh-entry__result" style={{ color: resultColor }}>
                    {hand.heroResult > 0 ? '+' : ''}{formatAmount(hand.heroResult)}
                </span>
                            ...
                            <div className="hh-entry__actions">
                                {street.actions.map((a, ai) => (
                                    <div key={ai} className="hh-entry__action">
                                        ...
                                        <span className="hh-entry__action-type" style={{ color: getActionColor(a.action) }}>
                                            {a.action}
                                        </span>
                                        {a.amount != null && (
            ...
            {sessionStats && (
                <div className="hh-panel__stats">
                    ...
                    <div className="hh-panel__stat">
                        ...
                        <span className="hh-panel__stat-value" style={{
                            color: sessionStats.totalResult > 0 ? '#22c55e' : sessionStats.totalResult < 0 ? '#ef4444' : '#9ca3af'
                        }}>
                            {sessionStats.totalResult > 0 ? '+' : ''}{formatAmount(sessionStats.totalResult)}
                        </span>
                    </div>
                    <div className="hh-panel__stat">
                        <span className="hh-panel__stat-label">Wins</span>
                        <span className="hh-panel__stat-value">{sessionStats.wins}/{sessionStats.handsPlayed}</span>
                    </div>
                </div>
            )}
