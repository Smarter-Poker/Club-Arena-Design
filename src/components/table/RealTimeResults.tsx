    ...
    <div className="rtr-overlay" onClick={onClose}>
      ...
      >
        ...
        <div className="rtr-header">
          ...
          <button className="rtr-close" onClick={onClose}>
            ×
          </button>
        </div>
        ...
        <div className="rtr-section">
          ...
          <div className="rtr-row">
            ...
            <span
              className={`rtr-value ${profitLoss >= 0 ? 'rtr-value--positive' : 'rtr-value--negative'}`}
            >
        ...
        <div className="rtr-summary">
          ...
          <span
            className={`rtr-summary-value ${profitLoss >= 0 ? 'rtr-summary-value--positive' : 'rtr-summary-value--negative'}`}
          >
            {profitLoss >= 0 ? '+' : ''}
