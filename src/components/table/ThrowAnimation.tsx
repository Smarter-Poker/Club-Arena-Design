    ...
    return (
        <div className="throw-animation">
            ...
            {phase === 'throw' && (
                ...
                >
                    <div className="throw-animation__icon">
                        {renderIcon(48)}
                    </div>
                </div>
            )}
...
export function ThrowAnimationContainer({ events, seatPositions, onEventComplete }: ThrowAnimationContainerProps) {
    const handleComplete = useCallback((eventId: string) => {
