  ...
  return (
    <div className={styles.overlay} onClick={onClose}>
      <div className={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        {/* P/L Hero */}
        <div
          className={`${styles.plHero} ${isProfit ? styles.profit : styles.loss} ${styles.plHeroReveal}`}
        >
        ...
        <div className={styles.statsGrid}>
          ...
          <div
            className={`${styles.statItem} ${visibleStats.has('hands') ? styles.statReveal : ''}`}
          >
          ...
          <div
            className={`${styles.statItem} ${visibleStats.has('stack') ? styles.statReveal : ''}`}
          >
          ...
          {totalRebuys > 0 && (
            <div className={styles.statItem}>
              <span className={styles.statValue}>{totalRebuys}</span>
