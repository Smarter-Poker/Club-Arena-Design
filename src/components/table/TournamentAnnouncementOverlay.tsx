...
const TournamentAnnouncementOverlay: React.FC<TournamentAnnouncementProps> = ({ type, data, onDismiss }) => {
    ...
    return (
        <div className={`tournamentAnnouncement ${visible ? 'visible' : ''}`} style={{ '--accent-color': c.color } as React.CSSProperties}>
