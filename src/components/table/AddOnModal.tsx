        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ fontSize: 32, fontWeight: 800, color: countdown <= 10 ? '#ef4444' : '#10b981' }}>
                        {countdown}s
                    </div>
                ...
                {!decided ? (
                    <>
                        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 16px', marginBottom: 4 }}>
                            <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: 14 }}>Add-On Cost</span>
                            <span style={{ color: '#fff', fontWeight: 600, fontSize: 14 }}>{addOnCost.toLocaleString()} chips</span>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 16px', marginBottom: 4 }}>
                            <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: 14 }}>Chips Received</span>
                            <span style={{ color: '#10b981', fontWeight: 600, fontSize: 14 }}>+{addOnChips.toLocaleString()} chips</span>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 16px', marginBottom: 16, borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: 12 }}>
                            <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: 14 }}>Your Balance</span>
                            <span style={{ color: canAfford ? '#fbbf24' : '#ef4444', fontWeight: 600, fontSize: 14 }}>
                        ...
                        <div style={{ display: 'flex', gap: 12 }}>
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    borderRadius: 10,
                                    border: 'none',
                                    background: canAfford ? 'linear-gradient(135deg, #10b981 0%, #059669 100%)' : '#374151',
                                    color: '#fff',
                                    fontSize: 14,
                                    fontWeight: 700,
