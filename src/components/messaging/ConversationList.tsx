...
export default function ConversationList({ clubId, onSelectConversation, selectedId }: ConversationListProps) {
    ...
    return (
        <div className={styles.container}>
            ...
            {isClubMember && (
                <div
                    className={styles.clubWidget}
                    onClick={() => navigate('/messages/clubs')}
                >
                    ...
                    {clubUnreadTotal > 0 && (
                        <span className={styles.clubWidgetBadge}>{clubUnreadTotal}</span>
                    )}
