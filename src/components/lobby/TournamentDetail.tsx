    ...
    <div className="tourney-overlay" onClick={onClose}>
      ...
      >
        ...
        <div className="tourney-header">
          ...
          <button className="tourney-close" onClick={onClose}>
            ×
          </button>
        </div>
        ...
        <div className="tourney-hero">
          ...
          <div className="hero-stat">
            ...
            <span className="hero-val highlight">
              {currency}
                    ...
                    <tr key={p.id}>
                      ...
                      <td>
                        {p.chipCount
                          ...
                          : tournament.chipStack.toLocaleString()}
                      </td>
                    </tr>
                  ))}
                  {players.length === 0 && (
        ...
        <div className="tourney-footer">
          {isRegistered ? (
            <button className="tourney-btn unregister" onClick={onUnregister}>
              Unregister
            </button>
          ) : (
            <button
            ...
            >
              {tournament.status === 'registering'
                ? `Register Now (${currency}${tournament.buyIn + tournament.fee})`
                : 'Registration Closed'}
            </button>
          )}
        </div>
