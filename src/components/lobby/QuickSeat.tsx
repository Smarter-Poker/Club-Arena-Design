  ...
  return (
    ...
    >
      ...
      <div className="quick-seat__actions">
        ...
        >
          {isProcessing ? (
            ...
            <>
              Quick Seat{' '}
              <span className="quick-seat__amount">{formatAmount(selectedAmount, currency)}</span>
            </>
          )}
        </button>
      ...
      <div className="quick-seat__balance">
        ...
        <span
          className={`quick-seat__balance-value ${!hasBalance ? 'quick-seat__balance-value--low' : ''}`}
        >
