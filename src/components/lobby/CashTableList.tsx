    ...
    <div className={`cash-table-row ${!table.isRunning ? 'cash-table-row--inactive' : ''}`}>
      ...
      <div className="cash-table-row__info">
        <div className="cash-table-row__header">
          <span
            className={`cash-table-row__variant cash-table-row__variant--${table.variant.toLowerCase()}`}
          >
            {table.variant}
          </span>
        ...
        {table.clubName && <span className="cash-table-row__club">{table.clubName}</span>}
      </div>
      ...
      <div className="cash-table-row__players">
        <div
          className="cash-table-row__seat-count"
...
export function CashTableList({
  ...
  const renderSortIndicator = (field: SortField) => {
    ...
    return (
      <span className="cash-table-list__sort-arrow">{sortDirection === 'asc' ? '▲' : '▼'}</span>
    );
  };
    ...
    return (
      <div className="cash-table-list cash-table-list--empty">
        <div className="cash-table-list__empty-state">
          ...
          <span className="cash-table-list__empty-hint">
  ...
  return (
    <div className="cash-table-list">
      ...
      <div className="cash-table-list__header">
        ...
        <div className="cash-table-list__column cash-table-list__column--actions">Actions</div>
      </div>
      ...
      <div className="cash-table-list__footer">
        <span className="cash-table-list__count">
          ...
          {tables.reduce((sum, t) => sum + t.seatedPlayers, 0)} players
        </span>
      </div>
    </div>
  );
