...
export const COMMON_STAKES = [
    ...
    { sb: 0.05, bb: 0.10, label: 'Micro: 0.05/0.10' },
    { sb: 0.10, bb: 0.25, label: 'Low: 0.10/0.25' },
    { sb: 0.25, bb: 0.50, label: 'Low: 0.25/0.50' },
    { sb: 0.50, bb: 1.00, label: 'Low: 0.50/1.00' },
