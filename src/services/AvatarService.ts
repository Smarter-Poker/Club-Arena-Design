...
const AVATAR_LIBRARY: Omit<Avatar, 'isOwned'>[] = [
    ...
    { id: 'fierce-lion', name: 'Fierce Lion', imageUrl: '/avatars/fierce-lion.png', category: 'free' },
    { id: 'clever-octopus', name: 'Clever Octopus', imageUrl: '/avatars/clever-octopus.png', category: 'free' },
    { id: 'swift-eagle', name: 'Swift Eagle', imageUrl: '/avatars/swift-eagle.png', category: 'free' },
    { id: 'night-wolf', name: 'Night Wolf', imageUrl: '/avatars/night-wolf.png', category: 'free' },
    { id: 'royal-tiger', name: 'Royal Tiger', imageUrl: '/avatars/royal-tiger.png', category: 'free' },
    ...
    { id: 'ninja-master', name: 'Ninja Master', imageUrl: '/avatars/ninja-master.png', category: 'free' },
    { id: 'pirate-captain', name: 'Pirate Captain', imageUrl: '/avatars/pirate-captain.png', category: 'free' },
    { id: 'cyber-punk', name: 'Cyber Punk', imageUrl: '/avatars/cyber-punk.png', category: 'free' },
    { id: 'street-artist', name: 'Street Artist', imageUrl: '/avatars/street-artist.png', category: 'free' },
    { id: 'jazz-musician', name: 'Jazz Musician', imageUrl: '/avatars/jazz-musician.png', category: 'free' },
    { id: 'dj-spinner', name: 'DJ Spinner', imageUrl: '/avatars/dj-spinner.png', category: 'free' },
    { id: 'yoga-master', name: 'Yoga Master', imageUrl: '/avatars/yoga-master.png', category: 'free' },
    { id: 'surfer-dude', name: 'Surfer Dude', imageUrl: '/avatars/surfer-dude.png', category: 'free' },
    ...
    { id: 'wall-street-wolf', name: 'Wall Street Wolf', imageUrl: '/avatars/wall-street-wolf.png', category: 'vip' },
    { id: 'diamond-dealer', name: 'Diamond Dealer', imageUrl: '/avatars/diamond-dealer.png', category: 'vip' },
    { id: 'casino-king', name: 'Casino King', imageUrl: '/avatars/casino-king.png', category: 'vip' },
    { id: 'poker-princess', name: 'Poker Princess', imageUrl: '/avatars/poker-princess.png', category: 'vip' },
    { id: 'vegas-legend', name: 'Vegas Legend', imageUrl: '/avatars/vegas-legend.png', category: 'vip' },

    // Myths & Fantasy
    { id: 'phoenix-rising', name: 'Phoenix Rising', imageUrl: '/avatars/phoenix-rising.png', category: 'vip' },
    ...
    { id: 'shadow-knight', name: 'Shadow Knight', imageUrl: '/avatars/shadow-knight.png', category: 'vip' },
    { id: 'cosmic-wizard', name: 'Cosmic Wizard', imageUrl: '/avatars/cosmic-wizard.png', category: 'vip' },
    ...
    { id: 'card-counter', name: 'Card Counter', imageUrl: '/avatars/card-counter.png', category: 'vip' },
    { id: 'bluff-master', name: 'Bluff Master', imageUrl: '/avatars/bluff-master.png', category: 'vip' },
    { id: 'chip-stacker', name: 'Chip Stacker', imageUrl: '/avatars/chip-stacker.png', category: 'vip' },
    ...
    { id: 'heads-up-hero', name: 'Heads Up Hero', imageUrl: '/avatars/heads-up-hero.png', category: 'vip' },
    ...
    { id: 'plo-specialist', name: 'PLO Specialist', imageUrl: '/avatars/plo-specialist.png', category: 'vip' },

    // Sports & Action
    { id: 'championship-boxer', name: 'Championship Boxer', imageUrl: '/avatars/championship-boxer.png', category: 'vip' },
    { id: 'formula-racer', name: 'Formula Racer', imageUrl: '/avatars/formula-racer.png', category: 'vip' },
    { id: 'home-run-hero', name: 'Home Run Hero', imageUrl: '/avatars/home-run-hero.png', category: 'vip' },
    ...
    { id: 'golf-champion', name: 'Golf Champion', imageUrl: '/avatars/golf-champion.png', category: 'vip' },
    { id: 'hockey-star', name: 'Hockey Star', imageUrl: '/avatars/hockey-star.png', category: 'vip' },
    { id: 'soccer-legend', name: 'Soccer Legend', imageUrl: '/avatars/soccer-legend.png', category: 'vip' },
    { id: 'mma-warrior', name: 'MMA Warrior', imageUrl: '/avatars/mma-warrior.png', category: 'vip' },
    { id: 'olympic-gold', name: 'Olympic Gold', imageUrl: '/avatars/olympic-gold.png', category: 'vip' },

    // Luxury & Lifestyle
    { id: 'yacht-captain', name: 'Yacht Captain', imageUrl: '/avatars/yacht-captain.png', category: 'vip' },
    { id: 'jet-setter', name: 'Jet Setter', imageUrl: '/avatars/jet-setter.png', category: 'vip' },
    { id: 'penthouse-prince', name: 'Penthouse Prince', imageUrl: '/avatars/penthouse-prince.png', category: 'vip' },
    { id: 'art-collector', name: 'Art Collector', imageUrl: '/avatars/art-collector.png', category: 'vip' },
    { id: 'wine-connoisseur', name: 'Wine Connoisseur', imageUrl: '/avatars/wine-connoisseur.png', category: 'vip' },
    { id: 'fashion-mogul', name: 'Fashion Mogul', imageUrl: '/avatars/fashion-mogul.png', category: 'vip' },
    { id: 'crypto-whale', name: 'Crypto Whale', imageUrl: '/avatars/crypto-whale.png', category: 'vip' },
    { id: 'venture-guru', name: 'Venture Guru', imageUrl: '/avatars/venture-guru.png', category: 'vip' },
    { id: 'night-owl-vip', name: 'Night Owl VIP', imageUrl: '/avatars/night-owl-vip.png', category: 'vip' },
