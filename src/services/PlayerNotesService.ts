...
export const PLAYER_TAGS = [
    '🐟 Fish', ' Shark', ' Gambler', '🧊 Tight', ' Aggro',
    '🐢 Passive', ' Whale', ' Tricky', ' Slow', '🏃 Fast',
    ' Improving', ' Tilting', ' Bluffer', ' Nit', '🌊 Calling Station'
];
...
class PlayerNotesServiceClass {
    ...
    async saveNote(
        ...
        await supabase.rpc('fn_save_player_note', {
            p_user_id: userId,
            p_target_id: targetId,
            p_note: note,
            p_color: color,
