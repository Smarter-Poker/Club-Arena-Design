...
export const RevenueSplitEditor: React.FC<RevenueSplitEditorProps> = ({
    ...
    const [splits, setSplits] = useState<Record<string, number>>(() => {
        ...
        clubs.forEach(c => { initial[c.clubId] = c.splitPercentage; });
        return initial;
    });
    ...
    const handleApplyDefault = () => {
        ...
        clubs.forEach(c => { newSplits[c.clubId] = defaultSplit; });
        setSplits(newSplits);
    };
                    ...
                    <div key={club.clubId} className="split-row">
                        <div className="club-info">
                            ...
                            <div className="club-details">
                                ...
                                <div className="club-volume">
                                    30d Volume: {club.volume30d.toLocaleString()}
                                </div>
                            </div>
                        </div>
