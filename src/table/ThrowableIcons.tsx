...
export function ClapIcon({ size = 48 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
            ...
            />
            {/* Impact lines */}
            <path d="M24 8v6M18 10l2 4M30 10l-2 4" stroke="#FF6B6B" strokeWidth="2" strokeLinecap="round" />
        </svg>
    );
}
...
export function SadIcon({ size = 48 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
            ...
            {/* Sad mouth */}
            <path d="M16 34c4-4 12-4 16 0" stroke="#2D2D2D" strokeWidth="2" strokeLinecap="round" fill="none" />
            {/* Tears */}
...
export function MadIcon({ size = 48 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
            ...
            {/* Steam */}
            <path d="M6 8c2-4 6-4 8 0M34 8c2-4 6-4 8 0" stroke="#FF4444" strokeWidth="2" strokeLinecap="round" />
        </svg>
    );
}
...
export function TomatoIcon({ size = 48 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
            ...
            <path d="M20 36c2-2 6-2 8 0" stroke="#2D2D2D" strokeWidth="2" strokeLinecap="round" fill="none" />
            {/* Highlight */}
...
export function PieIcon({ size = 48 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
            ...
            {/* Pie base */}
            <path
                d="M8 36c0-12 6-24 16-24s16 12 16 24"
                fill="#8D6E63"
                stroke="#2D2D2D"
                strokeWidth="2"
            />
...
export function BeerIcon({ size = 48 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
            {/* Mug */}
            <rect x="8" y="14" width="24" height="30" rx="4" fill="#FFB74D" stroke="#2D2D2D" strokeWidth="2" />
            {/* Handle */}
            <path
...
export function ChampagneIcon({ size = 48 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
            ...
            {/* Spray */}
            <path d="M24 4l-8-2M24 4l8-2M24 4v-4" stroke="#FFD700" strokeWidth="2" strokeLinecap="round" />
            {/* Bubbles */}
...
export function TrophyIcon({ size = 48 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
            ...
            <rect x="16" y="38" width="16" height="6" rx="2" fill="#FFD700" stroke="#2D2D2D" strokeWidth="2" />
            {/* Star */}
...
export function CloverIcon({ size = 48 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
            {/* Four leaves */}
            <ellipse cx="18" cy="18" rx="8" ry="10" fill="#4CAF50" stroke="#2D2D2D" strokeWidth="2" transform="rotate(-45 18 18)" />
            <ellipse cx="30" cy="18" rx="8" ry="10" fill="#4CAF50" stroke="#2D2D2D" strokeWidth="2" transform="rotate(45 30 18)" />
            <ellipse cx="18" cy="30" rx="8" ry="10" fill="#4CAF50" stroke="#2D2D2D" strokeWidth="2" transform="rotate(45 18 30)" />
            <ellipse cx="30" cy="30" rx="8" ry="10" fill="#4CAF50" stroke="#2D2D2D" strokeWidth="2" transform="rotate(-45 30 30)" />
            {/* Stem */}
...
export function CardsIcon({ size = 48 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
            {/* Back card */}
            <rect x="8" y="8" width="24" height="32" rx="3" fill="#1E88E5" stroke="#2D2D2D" strokeWidth="2" transform="rotate(-15 20 24)" />
            {/* Middle card */}
            <rect x="14" y="6" width="24" height="32" rx="3" fill="#E53935" stroke="#2D2D2D" strokeWidth="2" />
            {/* Front card */}
            <rect x="20" y="8" width="24" height="32" rx="3" fill="#FFFFFF" stroke="#2D2D2D" strokeWidth="2" transform="rotate(15 32 24)" />
            {/* Card face - Ace */}
            <text x="28" y="26" fontSize="16" fontWeight="bold" fill="#E53935" textAnchor="middle">A</text>
...
export function FishIcon({ size = 48 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
            ...
            {/* Scales pattern */}
            <path d="M20 20c2-1 4 0 4 2M24 24c2-1 4 0 4 2M28 20c2-1 4 0 4 2" stroke="#E65100" strokeWidth="1" fill="none" />
        </svg>
    );
}
...
export function SharkIcon({ size = 48 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
            ...
            {/* Head */}
            <path d="M6 28c0-6 6-12 12-12v24c-6 0-12-6-12-12z" fill="#607D8B" stroke="#2D2D2D" strokeWidth="2" />
            {/* Dorsal fin */}
...
export function ChipsIcon({ size = 48 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
            ...
            {/* Flying chip */}
            <ellipse cx="36" cy="10" rx="8" ry="3" fill="#FFD700" stroke="#2D2D2D" strokeWidth="2" transform="rotate(-20 36 10)" />
            {/* Sparkles */}
...
export function DiamondIcon({ size = 48 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
            {/* Diamond shape */}
            <path
                d="M24 4l16 12-16 28L8 16l16-12z"
                fill="#64B5F6"
                stroke="#2D2D2D"
                strokeWidth="2"
            />
...
export function DragonIcon({ size = 48 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
            ...
            {/* Tail */}
            <path d="M42 30c4 4 4 10 0 14" stroke="#4CAF50" strokeWidth="4" strokeLinecap="round" fill="none" />
        </svg>
    );
}
...
export function CrownIcon({ size = 48 }: { size?: number }) {
    return (
        <svg width={size} height={size} viewBox="0 0 48 48" fill="none">
            ...
            />
            {/* Crown band */}
            <rect x="6" y="36" width="36" height="6" rx="2" fill="#FFC107" stroke="#2D2D2D" strokeWidth="2" />
            {/* Jewels */}
