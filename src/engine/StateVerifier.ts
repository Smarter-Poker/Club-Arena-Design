 ...
 *
 * Called between hands by HeadlessTableEngine.
 * Emits STATE_INTEGRITY_VIOLATION on any mismatch.
 */

import { masterBus } from '../core/MasterBus';
import type { Card, SeatPlayer } from '../types/database.types';
...
export interface VerificationContext {
  ...
  initialChipTotal?: number; // Total chips at start of hand (stacks + blinds)
}
...
export const stateVerifier = new StateVerifierClass();
