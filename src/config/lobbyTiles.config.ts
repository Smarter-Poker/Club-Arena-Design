...
const LOBBY_TILES: LobbyTile[] = [
    { img: `${BASE}images/tiles/player-stats.jpg`, alt: 'Player Stats', route: '/profile', shortcutKey: '1' },
    { img: `${BASE}images/tiles/leaderboards.jpg`, alt: 'Leaderboards', route: '/leaderboard', shortcutKey: '2' },
    ...
    { img: `${BASE}images/tiles/hand-histories.jpg`, alt: 'Hand Histories', route: '/hands', shortcutKey: '5' },
];
