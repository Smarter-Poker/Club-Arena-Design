                ...
                <section className="settings-section">
                    ...
                    <div className="toggle-row">
                        ...
                        <button
                            ...
                            disabled={!isOwner}
                        >{settings.is_public ? 'ON' : 'OFF'}</button>
                    </div>
                    <div className="toggle-row">
                        <div className="toggle-info">
                        ...
                        <button
                            ...
                            disabled={!isOwner}
                        >{settings.requires_approval ? 'ON' : 'OFF'}</button>
                    </div>
                </section>
                ...
                <section className="settings-section">
                    ...
                    <div className="toggle-row">
                        ...
                        <button
                            ...
                            disabled={!isOwner}
                        >{settings.allow_straddle ? 'ON' : 'OFF'}</button>
                    </div>
                    <div className="toggle-row">
                        <div className="toggle-info">
                        ...
                        <button
                            ...
                            disabled={!isOwner}
                        >{settings.allow_run_it_twice ? 'ON' : 'OFF'}</button>
                    </div>
                    <div className="toggle-row">
                        <div className="toggle-info">
                        ...
                        <button
                            ...
                            disabled={!isOwner}
                        >{settings.allow_rabbit_hunt ? 'ON' : 'OFF'}</button>
                    </div>
                </section>
                ...
                <div className="modal-overlay" onClick={() => setShowDeleteModal(false)}>
                    <div className="modal-content delete-modal" onClick={e => e.stopPropagation()}>
                        ...
                        <p>
                            ...
                            club <strong>{settings.name}</strong> and remove all members.
                        </p>
                        <div className="form-group">
