...
export default function PlayerWalletPage() {
  ...
  const { balances, diamonds, isLoadingWallet, loadBalances, loadDiamonds, internalTransfer } =
    useWalletStore();
    ...
    <div className="wallet-page">
      ...
      >
        {(['overview', 'transfer', 'history'] as WalletTab[]).map((tab) => (
          ...
          >
            {tab === 'overview' ? 'Overview' : tab === 'transfer' ? 'Transfer' : 'History'}
          </button>
        ))}
      </div>
                ...
                <MetalCard size="md" glow>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ fontSize: '0.8rem', color: '#6a7a8a' }}>
                        {walletInfo[type].description}
                      </div>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <div style={{ textAlign: 'center' }}>
                      ...
                      <div
                        style={{ fontSize: '0.7rem', color: '#6a7a8a', textTransform: 'uppercase' }}
                      >
                        Available
                      </div>
                    </div>
                    <div style={{ textAlign: 'center' }}>
                      <div style={{ fontSize: '1.1rem', fontWeight: 700, color: '#ff9500' }}>
                        {balances[type].locked.toLocaleString()}
                      </div>
                      <div
                        style={{ fontSize: '0.7rem', color: '#6a7a8a', textTransform: 'uppercase' }}
                      >
                    ...
                    <div style={{ textAlign: 'center' }}>
                      <div style={{ fontSize: '1.1rem', fontWeight: 700, color: '#fff' }}>
                        {balances[type].total.toLocaleString()}
                      </div>
                      <div
                        style={{ fontSize: '0.7rem', color: '#6a7a8a', textTransform: 'uppercase' }}
                      >
