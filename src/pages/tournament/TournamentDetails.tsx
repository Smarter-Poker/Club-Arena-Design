  ...
  return (
    <div className="tournament-details">
      ...
      <div className="tournament-desc">
        ...
        {(tournament as any).is_xmtt && <p style={{ color: '#a78bfa' }}>UNION TOURNAMENT (XMTT)</p>}
        {((tournament as any).variant === 'spin' ||
                ...
                {entries
                  ...
                  .map((player) => {
                    ...
                    const prize = payoutEntry
                      ? Math.trunc((tournament.prize_pool || 0) * (payoutEntry as any).percentage) /
                        100
                      : 0;
                    return (
          ...
          <div className="quick-stats">
            ...
            <div className="stat">
              ...
              <span className="stat-value">
                {entries.filter((e) => e.status === 'playing' || e.status === 'registered').length}
                  ...
                  return (
                    ...
                    >
                      <span
                        ...
                        style={
                          isPlaying && idx === 0 ? { color: '#fbbf24', fontWeight: 700 } : undefined
                        }
                      >
                        {rank}
                      </span>
          ...
          {(tournament as any).is_xmtt && (tournament as any).union_id ? (
            <div className="union-info">
              ...
              <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: 13, marginTop: 8 }}>
                This tournament spans multiple clubs within the union. Players from all member clubs
                can participate.
              </p>
              <div className="info-row">
        ...
        <div className="modal-overlay" onClick={() => setShowSignUpModal(false)}>
          <div className="signup-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div
              ...
              style={{ borderTop: '1px solid rgba(255,255,255,0.1)', paddingTop: 8, marginTop: 4 }}
            >
