...
const BLIND_STRUCTURES = {
    TURBO: [
        ...
        { level: 0, smallBlind: 0, bigBlind: 0, ante: 0, durationMinutes: 3, isBreak: true },
    ...
    STANDARD: [
        ...
        { level: 0, smallBlind: 0, bigBlind: 0, ante: 0, durationMinutes: 5, isBreak: true },
...
const HOURLY_SCHEDULE: HourlyTournamentBlock[] = [
    ...
    },
    {
        hours: [12, 13, 14],
        tournaments: [
            { name: 'Lunch Rush (NLH Deep)', type: 'mtt', gameVariant: 'nlh', buyIn: 12, rake: 1.20, guarantee: 300, startingStack: 6000, maxPlayers: 100, minPlayers: 12, horsesToRegister: 20, blindStructure: BLIND_STRUCTURES.STANDARD, payoutStructure: PAYOUT_STRUCTURES.NINE },
            { name: 'Noon Grinder (Pineapple)', type: 'mtt', gameVariant: 'ofc_pineapple', buyIn: 5, rake: 0.50, guarantee: 100, startingStack: 3000, maxPlayers: 30, minPlayers: 6, horsesToRegister: 12, blindStructure: BLIND_STRUCTURES.TURBO, payoutStructure: PAYOUT_STRUCTURES.FIVE },
        ],
    },
    {
        hours: [15, 16, 17],
...
export class TournamentRecurringService {
    ...
    private async createSpin(config: SpinConfig): Promise<{ tournamentId: string | null; registered: number }> {
        try {
            const startTime = new Date(Date.now() + 60 * 1000);
